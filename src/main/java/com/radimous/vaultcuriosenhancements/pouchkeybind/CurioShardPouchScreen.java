...
public class CurioShardPouchScreen extends AbstractContainerScreen<CurioShardPouchContainer> {
    private static final ResourceLocation TEXTURE = VaultMod.id("textures/gui/shard_pouch.png");

    public CurioShardPouchScreen(CurioShardPouchContainer screenContainer, Inventory inv, Component titleIn) {
